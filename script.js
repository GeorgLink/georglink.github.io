...
var Compass = {
    init: function() {
        $(".triggers li").hover(function() {
            ...
            $(".description").html(e).stop(true,false).animate({'opacity': '1', 'display':'block'}, 400)
            //$(".description").show().html(e)
        }, function() {
            //$(".description").animate({'display': 'none'})//.html("")
            $(".description").stop(true,false).delay(200).animate({'opacity': '0'}, 600)//.html("")
        });
